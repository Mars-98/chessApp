...
class King(Sprite):
    # Where the king is on the board using tile locations
    placement = (0, 0)

    # Whether the king is black or white
    color_black = True
    ...
    def __init__(self, window, column, tile_size, board_size, color_black, tile_links):
        ...
        if color_black:
            ...
            rel_path = "../chess_pieces_bitmap/black_king.bmp"
        else:
            row = 7
            script_dir = os.path.dirname(__file__)
            rel_path = "../chess_pieces_bitmap/white_king.bmp"
    ...
    # Used for placing and moving a king to a specific pixel place
